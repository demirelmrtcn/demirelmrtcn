...
Statistics graduate from **Yıldız Technical University** (3rd in department, High Honors). Currently building ML models for Turkey's banking sector at **Akbank**.
...
| [**Movie Recommendation**](https://github.com/demirelmrtcn/Movie-Recommendation) | Content-based recommendation system | `Python` `Pandas` |

---

### 🎓 Education & Certifications

**Yıldız Technical University** — B.Sc. Statistics (2019–2023)  
*3rd in Department • High Honors Graduate*
